<template>
    <div id="LoginPage" class="w-full h-[100vh] h-screen pt-32">
        <div class="w-full">
            ...
            <div class="max-[350px] mx-auto px-2 text-white">
                <div class="text-center mb-6 mt-4">Login / Register</div>


                <button
                    @click="login('github')"
                    class="flex items-center justify-center gap-3 p-1.5 w-auto px-5 mx-auto border rounded-full text-lg font-semibold"
                >
