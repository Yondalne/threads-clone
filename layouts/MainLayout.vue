        ...
        >
            <div class="flex w-full max-w-[500px] mx-auto flex items-center justify-around">
                <button
                    ...
                    class="w-full h-full"
                >
                    <Icon class="mt-3" name="material-symbols:home-outline" size="35" color="#ffffff" />
                </button>
                <button
                    @click="userStore.isMenuOverlay = true"
                    class="w-full h-full"
                >
                    <Icon class="mt-2" name="material-symbols:edit-square-outline-rounded" size="32" color="#ffffff" />
                </button>
                <button
                    @click="userStore.isLogoutOverlay = true"
                    class="w-full h-full"
                >
                    <Icon class="mt-3" name="ph:sign-out" size="32" color="#ffffff" />
                </button>
            </div>
