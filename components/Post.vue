        ...
        <div class="py-2 w-full">
            <div class="flex items-center justify-between">
                ...
                >
                    <button
                        :disabled="isDeleting"
                        class="flex items-center text-center p-1 h-[24px] w-[24px] hover:bg-gray-800 rounded-full cursor-pointer"
            ...
            <div class="relative flex items-center w-full ">
                ...
                <div class="bg-black rounded-lg w-[calc(100%-50px)] text-sm w-full font-light">
                    ...
                    <img 
                        ...
                        class="mx-auto w-full mt-2 rounded"
...
const hasLinkedComputed = computed(() => {
